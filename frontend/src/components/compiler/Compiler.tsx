        ...
        <div className="heading">
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: '10px', justifyContent: 'flex-start' }}>
              ...
              <Button
                variant="contained"
                onClick={() => compileCode('C++')}
                style={clickedButton === 'C++' ? clickedButtonStyle : buttonStyle}
                className={clickedButton === 'C++' ? 'clicked' : ''}
              >
                C++
              </Button>
              <Button
                ...
                style={clickedButton === 'TypeScript' ? clickedButtonStyle : buttonStyle}
                className={clickedButton === 'TypeScript' ? 'clicked' : ''}
              >
                TypeScript
              </Button>
            </div>
