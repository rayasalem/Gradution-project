...
const LessonNine: React.FC = () => {
  ...
  const lessonData = {
    title: 'Understanding HTML Metadata',
    order: 9,
    course: courseId || '',
  };
  ...
  return (
    <div>
      <LessonSlide key="LessonMetadata" lessonData={lessonData} slides={slides} selectedAnswer={selectedAnswer} setSelectedAnswer={setSelectedAnswer} />
    </div>
  );
};
