...
const LessonTwo: React.FC= () => {
    ...
    const lessonData = {
      title: 'Lesson Two in html Course',
      order: 2,
      course: courseId || '',
    };
  ...
  return (
    <div>
   <LessonSlide key="lessonTwo" lessonData={lessonData} slides={slides} selectedAnswer={selectedAnswer} setSelectedAnswer={setSelectedAnswer} />
