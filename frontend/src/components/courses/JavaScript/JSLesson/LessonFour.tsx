...
const LessonFourjs: React.FC = () => {
  ...
  const lessonData = {
    title: 'Control Flow and Loops in JavaScript',
    order: 4,
    course: courseId || '',
  };
  ...
  return (
    <div>
      <LessonSlide key="lessonFour" lessonData={lessonData} slides={slides} selectedAnswer={selectedAnswer} setSelectedAnswer={setSelectedAnswer} />
    </div>
  );
};
